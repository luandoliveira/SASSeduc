                    ...
                    <div class="table-responsive-xl  table-sm">
                        <table id="example" class="table table-striped table-bordered"
                            ...
                            <tbody class="text-center">
                                ...
                                @php
                                $users=$projeto->find($projeto->id)->relUsers;
                                @endphp
                                <tr>
                                    <td>{{$projeto->projeto}}</td>
                                    <td>{{$projeto->escola}}</td>
                                    <td>{{$projeto->coordenadoria}}</td>
                                    <td>{{$projeto->municipio}}</td>
                                    <td>{{$projeto->sigeam}}</td>
                                    ...
                                    @endif
                                    <td>
                                        <a style="padding-left:10px;" href="{{url("/projetos/fase/$projeto->id")}}">
                            ...
                            @else
                            <h2>Você não possui projetos!</h2>
                            @endif
                            </tbody>
                            <!-- <tfoot>
            <tr>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header" style="background-color:#2e75b6">
                                                                ...
                                                                @if (auth()->user()->avatar != null)
                                                                <img class="rounded-pill img-fluid" width="38"
                                                                    src="{{auth()->user()->avatar}}"
                                                                    class="dropdown-toggle" data-toggle="dropdown"
                                                                    aria-haspopup="true" aria-expanded="false"></img>
                                                                @else
                                                                <img src="{{asset('img/usuario.png')}}" width="32"
                                                                    height="32"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="d-none alert alert-danger" id="senha"
                                                                    role="alert">As senhas não são idênticas!
                                                                </div>

                                                                <form class="needs-validation" name="formEdit"
                                                                    novalidate>
                                                                    @csrf
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-12 mb-6">
                                                                            <label
                                                                                for="validationCustomUsername">Senha</label>
                                                                            <div class="input-group">
                                                                                <div class="input-group-prepend">
                                                                                    <!-- <span class="input-group-text" id="inputGroupPrepend">*</span> -->
                                                                                </div>
                                                                        ...
                                                                        <div class="col-md-12 mb-6">
                                                                            <label
                                                                                for="validationCustomUsername">Confirmar
                                                                                Senha</label>
                                                                            <div class="input-group">
                                                                                <div class="input-group-prepend">
                                                                                    <!-- <span class="input-group-text" id="inputGroupPrepend">*</span> -->
